...
func TestFormatWorkerOnceResultIncludesDispatchCounters(t *testing.T) {
	line := formatWorkerOnceResult(worker.Result{
		...
		DispatchCandidatesScanned:               11,
		DispatchesRequested:                     12,
		DispatchesAlreadyRequested:              13,
		DispatchesSkippedMissingCultivar:        14,
		ConvergenceCandidatesScanned:            15,
		ConvergenceVerdictsRecorded:             16,
		ConvergenceVerdictsAlreadyRecorded:      17,
		ConvergenceStaleInputsSkipped:           18,
		ConvergenceAccepts:                      19,
		ConvergenceRetries:                      20,
		ConvergenceEscalations:                  21,
	})

	for _, want := range []string{
		"patience_dispatches=6",
		"patience_dispatches_already_requested=7",
		"dispatch_candidates=11",
		"dispatch_requested=12",
		"dispatch_already_requested=13",
		"dispatch_skipped_missing_cultivar=14",
		"convergence_verdicts=33",
	} {
