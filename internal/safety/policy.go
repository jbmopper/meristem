...
// MustValidateStartup returns the default policy after validating it. Runtime
// entry points call this before opening long-lived services; tests can call it
// to assert the binary still has a complete safety envelope.
