...
func TestValidateWorkSpecRejectsMissingRequiredFields(t *testing.T) {
	raw := json.RawMessage(`{"schema_version":"wayline.work_spec.v1","kind":"repair","title":"x","priority":"P1"}`)
...
func TestValidateWorkSpecRejectsInvalidPriority(t *testing.T) {
	raw := json.RawMessage(`{"schema_version":"wayline.work_spec.v1","kind":"repair","title":"x","priority":"P9","acceptance_criteria":["x"]}`)
...
func TestValidateWorkSpecRejectsUnknownTopLevelField(t *testing.T) {
	raw := json.RawMessage(`{"schema_version":"wayline.work_spec.v1","kind":"repair","title":"x","priority":"P1","acceptance_criteria":["x"],"surprise":true}`)
